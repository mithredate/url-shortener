...
class ShortenedUrlControllerTest {
    ...
    fun `should create short url`() {
        ...
        val data = objectMapper.readValue(response.body().byteInputStream(), Argument.of(JsonApiResponse::class.java, ShortUrlResource::class.java)).data as ShortUrlResource
